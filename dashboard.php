...
<div class="container-fluid">
	...
	<br />
	<div class="card">
		<div class="card-header"><h4>Lista de horarios de los médicos</h4></div>
			<div class="card-body">
      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                    	<label><b>Razón de la cita</b></label>
        		...
        		<div class="modal-footer">
          			...
          			<input type="submit" name="submit" id="submit_button" class="btn btn-success" value="Agendar" />
